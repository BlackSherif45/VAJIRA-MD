...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=eFc3nKwR#4sgdjaLjU9GMgaltzRGgK79mFQnhwNb8bqRxka98QWs
' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,263712196152" : process.env.MODERATORS ,    
...
AI_MODE: process.env.AI_MODE === undefined ? 'fasle' : process.env.AI_MODE,
